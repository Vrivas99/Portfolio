...
const Navbar = () => {
    ...
    return (
        <nav className="fixed z-20 bottom-5 gap-3 right-1/2 transform translate-x-1/2 md:right-10 md:top-1/2 md:-translate-y-1/2 md:gap-7 flex md:flex-col">
            <NavBtn href="#Home" tooltip="Inicio">
                <Home width={24}/>
            </NavBtn>
            <NavBtn href="#Experience" tooltip="Experiencia">
                <Work width={24} height={24}/>
            </NavBtn>
